  ...
  return (
    <Layout>
      <ImageContainer>
        ...
        <div className="grid gap-6 grid-cols-2 space-y-24 max-h-full">
          ...
          <div className="container flex max-h-full "> 
            ...
            <Img
              ...
              imgStyle={{objectFit: 'contain', maxHeight: '50vh', width: '100%'}}
              />
          </div>
        ...
        {/* Row 7 */}
        <div className="grid grid-cols-3 container gap-12 my-24">
          <div className="container"> 
            <Img
        ...
        <div className="grid grid-cols-3 container my-24">
